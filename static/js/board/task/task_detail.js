// django_ma/static/js/board/task/task_detail.js

/**
 * django_ma/static/js/task_detail.js
 * - 댓글 수정 기능(인라인 편집) 개선:
...
document.addEventListener("DOMContentLoaded", () => {
   ...
   * ========================================================= */
  const boot = document.getElementById("taskDetailBoot");
  ...
  async function taskUpdate({ form, actionType, value }) {
  ...
  if (updateUrl) {
    ...
    document.addEventListener("change", async (e) => {
      ...
      try {
        const data = await taskUpdate({ form, actionType, value: sel.value });
